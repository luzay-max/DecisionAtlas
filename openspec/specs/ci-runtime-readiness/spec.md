...
Ensure GitHub Actions release validation remains compatible with current GitHub-hosted runner JavaScript runtimes and explicit Windows runner selection.
