# real-browser-workflow-rehearsal Specification

## Purpose
Defines a browser-driven human workflow rehearsal that proves DecisionAtlas users can move through the core product path while keeping real repository context and evidence boundaries explicit.
