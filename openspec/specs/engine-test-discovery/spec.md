...
Keep engine validation deterministic by limiting default pytest discovery to the canonical test suite and keeping temporary scratch artifacts out of package roots.
