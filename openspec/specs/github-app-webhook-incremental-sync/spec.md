...
The system SHALL allow an owner scope to register a GitHub App installation as a repository access source and bind imported repositories to that installation-backed source without changing repository identity.
