# self-hosted-license-and-support-boundary Specification

## Purpose
Define offline/self-hosted license tiers, support scope, entitlement evidence, and non-enforced evaluation boundaries for DecisionAtlas commercial handoff.
