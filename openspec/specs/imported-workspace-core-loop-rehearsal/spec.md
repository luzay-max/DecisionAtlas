# imported-workspace-core-loop-rehearsal Specification

## Purpose
Defines evidence for an imported workspace moving through setup/reuse, dashboard, review, why-search, drift, and governance guardrail lanes.
