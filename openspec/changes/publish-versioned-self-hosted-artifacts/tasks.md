...
- [ ] 4.4 Archive bounded publication/verification evidence, update the completion taskbook, dated update log, readiness history, and next-development plan without committing ZIP/tar.gz binaries.
