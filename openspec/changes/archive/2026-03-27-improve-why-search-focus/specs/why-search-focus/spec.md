...
The system SHALL present supporting accepted decisions separately from the main why-answer so users can tell which decision directly answers the question and which decisions only add adjacent context.
