...
- Generated: `2026-07-08T00:26:00+08:00`
...
- `product_controlled` `warning` multi_repo_diagnosis:n8n: source action categories include product-controlled core-loop work grounding={"reason_codes": [], "warning_lanes_with_grounding": 0}
- `product_controlled` `warning` multi_repo_diagnosis:rich: source action categories include product-controlled core-loop work grounding={"reason_codes": ["missing_accepted_decision_evidence"], "warning_lanes_with_grounding": 2}
