...
- Generated: `2026-07-08T01:11:00+08:00`
...
- `product_controlled` `warning` multi_repo_diagnosis:rich: source action categories include product-controlled core-loop work grounding={"reason_codes": ["missing_accepted_decision_evidence"], "warning_lanes_with_grounding": 2} accepted_baseline={"accepted_count": 0, "accepted_sample_titles": [], "candidate_count": 35, "candidate_sample_titles": ["Don't use windows legacy terminal support when ctypes is not available", "Fix infinite loop in split_graphemes with ANSI escape sequences", "Fix FORCE_COLOR making console interactive in CI environments"], "next_action": "review_candidates_into_accepted_baseline", "status": "empty", "strength": "none"}
