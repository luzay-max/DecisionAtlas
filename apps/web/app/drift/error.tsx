  ...
  return (
    <main className="home" style={{ minHeight: "100vh", display: "grid", placeItems: "center" }}>
      <div className="panel" style={{ maxWidth: "600px", textAlign: "center", padding: "48px" }}>
        <p className="eyebrow" style={{ color: "var(--danger)" }}>Drift error</p>
        <h2 style={{ marginTop: "12px", marginBottom: "16px" }}>Failed to load drift alerts</h2>
        <p style={{ color: "var(--muted)", marginBottom: "24px", lineHeight: 1.6 }}>
          {error.message || "Drift alerts could not be loaded. Check the engine and API services."}
        </p>
